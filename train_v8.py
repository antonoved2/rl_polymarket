#!/usr/bin/env python3
"""
PPO Training v8 — 95 features (v7 + multi-horizon ML).
...
Features:
  ...
  43-74: TA (32)
  75-82: ML forecast (8)
  83-94: multi-horizon ML (12) — h=1,3,5,10 × prob,conf,edge
"""
...
def train(
    ...
    print("=" * 60)
    print(f"  PPO Training v8 — {asset.upper()} — 95 features + multi-horizon ML")
    ...
    final_path = os.path.join(save_dir, f"ppo_v8_{asset}_steps{total_steps}")
    ...
    stats_path = os.path.join(save_dir, f"ppo_v8_{asset}_eval.json")
...
if __name__ == "__main__":
    ...
    data_path = args.data or f"/home/antonov5/.openclaw/workspace/rl_polymarket/data/expanded_snapshots_v4.jsonl"
