#!/usr/bin/env python3
"""
PPO Training v7 — 83 features (v6 + ML forecast).

New features (8 total, indices 75-82):
  ml_prob_up, ml_prob_down, ml_confidence, ml_prediction,
  ml_edge, ml_signal_strength, ml_raw_xgb, ml_raw_lgb

ML forecast is computed from TA features (approximation of XGB+LGB ensemble).
"""
...
def train(
    asset="btc",
    data_path="/home/antonov5/.openclaw/workspace/rl_polymarket/data/expanded_snapshots_v3.jsonl",
    total_steps=500_000,
    seed=42,
    save_dir="/home/antonov5/.openclaw/workspace/rl_polymarket/models",
):
    print("=" * 60)
    print(f"  PPO Training v7 — {asset.upper()} — 83 features + ML forecast")
    ...
    final_path = os.path.join(save_dir, f"ppo_v7_{asset}_steps{total_steps}")
    ...
    stats_path = os.path.join(save_dir, f"ppo_v7_{asset}_eval.json")
...
if __name__ == "__main__":
    ...
    data_path = args.data or f"/home/antonov5/.openclaw/workspace/rl_polymarket/data/expanded_snapshots_v3.jsonl"
